...
insert into USER values ('frodoHackins', 'toor', 'Frodo', null, 'Hackins', '1998-02-26', 999, 'Sprites/potato.png');
insert into USER2 values ('frodoHackins', '5736664200', 'svgntc@mst.edu');
insert into ADMIN values ('frodoHackins');
insert into CUSTOMER values ('frodoHackins', 2);
insert into BAN values ('frodoHackins', '9999-01-01');
...
insert into ADMIN values ('samiam');
insert into CUSTOMER values ('samiam', 0);


insert into PET values ('001', 'Kitty', 50, 'Sprites/kitty.png');
insert into PET values ('002', 'Buzz', 100, 'Sprites/bee.png');
insert into PET values ('003', 'Bunbun', 100, 'Sprites/bunbun.png');
insert into PET values ('004', 'Corgo', 150, 'Sprites/corgo.png');
insert into PET values ('005', 'Dino', 200, 'Sprites/dino.png');
insert into PET values ('006', 'Doggo', 50, 'Sprites/doggo.png');
insert into PET values ('007', 'Dragon', 300, 'Sprites/dragon.png');
insert into PET values ('008', 'Toot Toot', 150, 'Sprites/elephant.png');
insert into PET values ('009', 'Fox', 200, 'Sprites/foxx.png');
insert into PET values ('010', 'Ladybug', 100, 'Sprites/ladybug.png');
insert into PET values ('011', 'Squeeker', 100, 'Sprites/mouse.png');
insert into PET values ('012', 'Panda', 200, 'Sprites/panda.png');
insert into PET values ('013', 'Piggy', 100, 'Sprites/piggy.png');
insert into PET values ('014', 'Potato', 0, 'Sprites/potato.png');
insert into PET values ('015', 'Not Spyro', 300, 'Sprites/purpleboi.png');
insert into PET values ('016', 'Snek', 200, 'Sprites/snek.png');
insert into PET values ('017', 'Blue SpikyBoi', 100, 'Sprites/spikyboy.png');
insert into PET values ('018', 'Unicorn', 300, 'Sprites/unicorn.png');
