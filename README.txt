...
If init.bat fails (because XAMPP loves being unstable in command line apparently), here are the manual steps it performs:
...
4) Invoke the local server
	...
	- Run "npm install package.json" (this will donwload a couple modules that we require)
